...
def get_config():
  ...
  gait_config.pronk_initial_offset = np.array([0., 0., 0., 0.], dtype=np.float32) * (2 * np.pi)
  gait_config.pronk_swing_ratio = np.array([0.5, 0.5, 0.5, 0.5], dtype=np.float32)
  gait_config.bound_initial_offset = np.array([0.05, 0.05, -0.4, -0.4], dtype=np.float32) * (2 * np.pi)
  gait_config.bound_swing_ratio = np.array([0.6, 0.6, 0.6, 0.6], dtype=np.float32)
